...
![image-20240809085955706](images/Mysql笔记/image-20240809085955706.png)
...
![image-20240609022508755](images/Mysql笔记/image-20240609022508755.png)
...
![image-20240609022955947](images/Mysql笔记/image-20240609022955947.png)

日期时间类型

![image-20240609023540729](images/Mysql笔记/image-20240609023540729.png)
...
- #### DQL
  ...
  - DQL-执行顺序
    ...
    ![image-20240618043345099](images/Mysql笔记/image-20240618043345099.png)
...
![image-20240621005519399](images/Mysql笔记/image-20240621005519399.png)

​	注意:约束是作用于表中字段上的，可以在创建表/修改表的时候添加约束。

- 约束演示(auto_increment：自增)

  ![image-20240621010331717](images/Mysql笔记/image-20240621010331717.png)
...
- 外键约束
  ...
  ![image-20240621011935174](images/Mysql笔记/image-20240621011935174.png)
  ...
  - 删除/更新行为
    ...
    ![image-20240621013805034](images/Mysql笔记/image-20240621013805034.png)
...
![image-20240621101907184](images/Mysql笔记/image-20240621101907184.png)
...
![image-20240621152513511](images/Mysql笔记/image-20240621152513511.png)

​	幻读：同一个事务，前后两次查询相同的范围时，得到的数据条数不一致

5. 事务的隔离级别

   ![image-20240621154205169](images/Mysql笔记/image-20240621154205169.png)
...
1. 存储引擎层
   ...
   - **InnoDB**
     ...
     - 文件
      ...
      ![image-20240621161519314](images/Mysql笔记/image-20240621161519314.png)
...
![image-20240621162040291](images/Mysql笔记/image-20240621162040291.png)
...
2. 索引结构
   ...
   ![image-20240621163604716](images/Mysql笔记/image-20240621163604716.png)

   ![image-20240621163707900](images/Mysql笔记/image-20240621163707900.png)

   - 二叉树

     ![image-20240621163945282](images/Mysql笔记/image-20240621163945282.png)

   - B-Tree（**多路**平衡查找树）

     以一颗最大度数（max-degree)为5(5阶)的b-tree为例(每个节点最多存储4个key，5个指针):

     ![image-20240621164115913](images/Mysql笔记/image-20240621164115913.png)

   - B+Tree

     以一颗最大度数（ max-degree）为4(4阶）的b+tree为例:

     ![image-20240621164733955](images/Mysql笔记/image-20240621164733955.png)
   ...
   - B+Tree
     ...
     ![image-20240621165303792](images/Mysql笔记/image-20240621165303792.png)
...
3. 索引分类
   ...
   ![image-20240621171452760](images/Mysql笔记/image-20240621171452760.png)

   在InnoDB存储引擎中，根据索引的存储形式，又可以分为以下两种:

   ![image-20240621171649661](images/Mysql笔记/image-20240621171649661.png)
   ...
   **回表查询(涉及sql优化)**
   ...
   ![image-20240621172151734](images/Mysql笔记/image-20240621172151734.png)
...
5. **SQL性能分析（面试高频）**
   ...
   4. **explain执行计划**
      ...
      ![image-20240621181913275](images/Mysql笔记/image-20240621181913275.png)
...
- 参数
  ...
  ![image-20240622095840231](images/Mysql笔记/image-20240622095840231.png)
...
- 条件处理程序
  ...
  ![image-20240622104525806](images/Mysql笔记/image-20240622104525806.png)
...
- 介绍
  ...
  **支持行级触发**，不支持语句级触发。
  ...
  ![image-20240622110301332](images/Mysql笔记/image-20240622110301332.png)
...
- 介绍
  ...
  - 元数据锁（ meta datalock，MDL)
    ...
    **DML与DDL冲突，保证读写的正确性。**
    ...
    ![image-20240622133026098](images/Mysql笔记/image-20240622133026098.png)
...
- 介绍
  ...
  - 行锁
    ...
    ![image-20240622141806281](images/Mysql笔记/image-20240622141806281.png)
...
![image-20240622151500484](images/Mysql笔记/image-20240622151500484.png)
...
![image-20240622152309967](images/Mysql笔记/image-20240622152309967.png)
...
![image-20240622160240155](images/Mysql笔记/image-20240622160240155.png)
...
- readview
  ...
  ![image-20240622163325914](images/Mysql笔记/image-20240622163325914.png)

  ![image-20240622163531551](images/Mysql笔记/image-20240622163531551.png)
  ...
  - **READ COMMITTED∶在事务中每一次执行快照读时生成Readview。**
    ...
    **实现原理：**
    ...
    ![image-20240622164237831](images/Mysql笔记/image-20240622164237831.png)

  - **REPEATABLE READ:仅在事务中第一次执行快照读时生成ReadView，后续复用该ReadView。**

    **实现原理：**

    ![image-20240622165326522](images/Mysql笔记/image-20240622165326522.png)
...
- 系统数据库
  ...
  ![image-20240622171707880](images/Mysql笔记/image-20240622171707880.png)

- 常用工具

  该mysql不是指mysql服务，而是指mysql的客户端工具

  ![image-20240622171827625](images/Mysql笔记/image-20240622171827625.png)
  ...
  ![image-20240622172213545](images/Mysql笔记/image-20240622172213545.png)
...
- 日志格式
  ...
  ![image-20240622180409789](images/Mysql笔记/image-20240622180409789.png)
...
- 日志查看
  ...
  ![image-20240622180640557](images/Mysql笔记/image-20240622180640557.png)

- 日志删除

  对于比较繁忙的业务系统，每天生成的binlog数据巨大，如果长时间不清除，将会占用大量磁盘空间。可以通过以下几种方式清理日志;

  ![image-20240622181350813](images/Mysql笔记/image-20240622181350813.png)
...
- 介绍
  ...
  ![image-20240622181947828](images/Mysql笔记/image-20240622181947828.png)
...
![image-20240622183140830](images/Mysql笔记/image-20240622183140830.png)

##### 搭建

- 服务器准备

![image-20240622183533880](images/Mysql笔记/image-20240622183533880.png)
...
![image-20240622185627659](images/Mysql笔记/image-20240622185627659.png)

![image-20240622185818551](images/Mysql笔记/image-20240622185818551.png)

![image-20240622185843767](images/Mysql笔记/image-20240622185843767.png)

![image-20240622185919694](images/Mysql笔记/image-20240622185919694.png)
...
![image-20240622191601439](images/Mysql笔记/image-20240622191601439.png)
...
- 垂直拆分
  ...
  **垂直分库：**以表为依据，根据业务将不同表拆分到不同库中。
  ...
  3. 所有库的并集是全量数据。
     ...
     ![image-20240622191818444](images/Mysql笔记/image-20240622191818444.png)
...
![image-20240622192508531](images/Mysql笔记/image-20240622192508531.png)
...
- 水平拆分
  ...
  **水平分库**：以字段为依据，按照一定策略，将一个库的数据拆分到多个库中。
  ...
  ![image-20240622193000406](images/Mysql笔记/image-20240622193000406.png)
...
![image-20240622193058781](images/Mysql笔记/image-20240622193058781.png)
